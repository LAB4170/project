  ...
  return (
    <section id="inventory" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-blue-100 text-sm">Active vessels</div>
                </div>
              </div>
            </div>
              ...
              {arrivalsLoading ? (
                ...
                <div className="divide-y divide-gray-200">
                  {arrivals.map((arrival) => (
                    <div key={arrival.id} className="p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          <div className="font-bold text-lg text-slate-900">{arrival.vehicleCount}</div>
              ...
              {trendsLoading ? (
                ...
                <div className="divide-y divide-gray-200">
                  {trends.slice(0, 6).map((trend) => (
                    <div key={trend.id} className="p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="mb-12">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="text-amber-600 font-semibold">Just Arrived</span>
                    </div>
                  </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 via-green-50 to-purple-50 border-2 border-blue-200 rounded-2xl p-8">
